...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/theHonzic/test-public/releases/download/2.0.6/MinimalPackage.xcframework.zip",
            checksum: "10acc9f714dff94b178bbaeb07705dc3062b6f57e538a1562b097a10882236f1"
        ),
        .binaryTarget(
            name: "MinimalPackageCoreBinary",
            url: "https://github.com/theHonzic/test-public/releases/download/2.0.6/MinimalPackageCore.xcframework.zip",
            checksum: "PLACEHOLDER_CORE"
        ),
        .binaryTarget(
            name: "MinimalPackageFeatureBinary",
            url: "https://github.com/theHonzic/test-public/releases/download/2.0.6/MinimalPackageFeature.xcframework.zip",
